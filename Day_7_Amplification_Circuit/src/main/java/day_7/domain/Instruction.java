...
public class Instruction {
  ...
  private Instruction(IOHandler ioHandler, Integer opcode) {
    this.ioHandler = ioHandler;
    this.opcode = opcode;
  }

  private Instruction(IOHandler ioHandler, Integer opcode, Integer outputAddress) {
    this.ioHandler = ioHandler;
    this.opcode = opcode;
    this.outputAddress = outputAddress;
  }

  private Instruction(IOHandler ioHandler, Integer opcode, Integer[] params, Integer[] paramModes) {
    this.ioHandler = ioHandler;
    this.opcode = opcode;
    this.params = params;
  ...
  public static Instruction getNext(Memory memory, IOHandler ioHandler) {
    ...
    switch (opcode) {
      ...
      case 3:
        return new Instruction(ioHandler, opcode, memory.getValue(pointer + 1));
      case 4:
        return new Instruction(
            ioHandler,
            opcode,
      ...
      case 6:
        return new Instruction(
            ...
            null);
      case 99:
        return new Instruction(ioHandler, 99);
      default:
        throw new RuntimeException(
